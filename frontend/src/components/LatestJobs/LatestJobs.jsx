                    ...
                    <div className="space-y-4">
                        {jobs.slice(0, 6).map((job) => (
                            <div
                                ...
                                className={`flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-5 rounded-xl shadow-md hover:shadow-lg transition cursor-pointer ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'
                                    }`}
                            >
